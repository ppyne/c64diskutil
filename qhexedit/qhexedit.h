...
class QHEXEDIT_API QHexEdit : public QAbstractScrollArea {
        ...
        */
        ...
        /*! Property highlighting color sets (setHighlightedColor()) the background
        color of highlighted text areas. You can also read the color
        (highlightedColor()).
        */
        //Q_PROPERTY(QColor highlightedColor READ highlightedColor WRITE setHighlightedColor)
    ...
    public:
        ...
        QColor hexAreaColor();
        void setHexAreaColor(const QColor &color);
        ...
        QColor highlightedAreaColor();
        void setHighlightedAreaColor(const QColor &color);

        QColor highlightedFontColor();
        void setHighlightedFontColor(const QColor &color);

        // Selection

        QColor selectedAreaColor();
        void setSelectedAreaColor(const QColor &color);
        ...
        QColor cursorAreaColor();
        void setCursorAreaColor(const QColor &color);

        QColor cursorFontColor();
        void setCursorFontColor(const QColor &color);

        // Cursor read-only

        QColor cursorROAreaColor();
        void setCursorROAreaColor(const QColor &color);

        QColor cursorROFontColor();
        void setCursorROFontColor(const QColor &color);
    ...
    private:
        ...
        QColor _hexAreaColor;

        QColor _asciiAreaColor;
        QColor _asciiFontColor;

        QColor _highlightedAreaColor;
        QColor _highlightedFontColor;

        QColor _selectedAreaColor;
        QColor _selectedFontColor;

        QColor _cursorAreaColor;
        QColor _cursorFontColor;

        QColor _cursorROAreaColor;
        QColor _cursorROFontColor;
